...
const styles = StyleSheet.create({
  ...
  headerButton: { width: 44, height: 44, borderRadius: 999, alignItems: "center", justifyContent: "center", backgroundColor: "transparent", borderWidth: 1, borderColor: "rgba(104,83,69,0.14)" },
  ...
  heroCard: { overflow: "hidden", borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(104,83,69,0.10)" },
  ...
  heroBody: { paddingHorizontal: 20, paddingVertical: 18, gap: 10 },
  ...
  heroStatCard: { flex: 1, alignItems: "center", justifyContent: "center", gap: 4, borderRadius: 18, paddingVertical: 12, backgroundColor: "transparent", borderWidth: 1, borderColor: "rgba(104,83,69,0.12)" },
  ...
  searchBox: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "transparent", marginHorizontal: 20, paddingHorizontal: 0, paddingVertical: 13, borderBottomWidth: 1, borderColor: "rgba(104,83,69,0.14)" },
  searchInput: { flex: 1, padding: 0, fontSize: 14, fontFamily: "Poppins_400Regular", color: Colors.light.text },
  tabRow: { flexDirection: "row", gap: 10, paddingHorizontal: 20 },
  tabButton: { flex: 1, minHeight: 44, borderRadius: 999, alignItems: "center", justifyContent: "center", backgroundColor: "transparent", borderWidth: 1, borderColor: "rgba(104,83,69,0.14)" },
  tabButtonActive: { backgroundColor: "transparent", borderColor: Colors.light.tint },
  tabButtonText: { fontSize: 12, fontFamily: "Poppins_600SemiBold", color: Colors.light.textSecondary },
  tabButtonTextActive: { color: Colors.light.tint },
  sectionBlock: { gap: 12 },
  sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10, paddingHorizontal: 20 },
  ...
  categoryCard: { width: "47%", borderRadius: 18, padding: 12, backgroundColor: "transparent", borderWidth: 1, borderColor: "rgba(104,83,69,0.12)" },
  ...
  promoRow: { gap: 12, paddingHorizontal: 20, paddingRight: 20 },
  promoCard: { width: 172, borderRadius: 18, padding: 12, backgroundColor: "transparent", borderWidth: 1, borderColor: "rgba(104,83,69,0.12)" },
  ...
  sectionStack: { gap: 14, paddingHorizontal: 20 },
  categorySectionCard: { paddingVertical: 14, gap: 12, borderBottomWidth: 1, borderBottomColor: "rgba(104,83,69,0.10)" },
  ...
  productRailButton: { marginTop: 10, minHeight: 38, borderRadius: 999, alignItems: "center", justifyContent: "center", backgroundColor: Colors.light.tint },
  productRailButtonText: { color: "#fff", fontSize: 12, fontFamily: "Poppins_600SemiBold" },
  productListCard: { flexDirection: "row", gap: 12, paddingHorizontal: 20, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(104,83,69,0.10)" },
  ...
  productListButton: { marginTop: 8, minWidth: 88, minHeight: 38, borderRadius: 999, alignItems: "center", justifyContent: "center", backgroundColor: Colors.light.tint, paddingHorizontal: 12 },
