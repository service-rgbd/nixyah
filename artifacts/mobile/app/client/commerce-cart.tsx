...
const styles = StyleSheet.create({
  ...
  emptyWrap: { backgroundColor: Colors.light.card, borderRadius: 24, borderWidth: 1, borderColor: Colors.light.cardBorder, padding: 22, gap: 10, alignItems: "center" },
  ...
  storeHero: { borderRadius: 26, overflow: "hidden", borderWidth: 1, borderColor: Colors.light.cardBorder },
  storeHeroImage: { width: "100%", height: 148 },
  storeHeroBody: { padding: 16, gap: 5 },
  ...
  sectionCard: { backgroundColor: Colors.light.card, borderRadius: 24, borderWidth: 1, borderColor: Colors.light.cardBorder, padding: 16, gap: 14 },
  ...
  qtyBtn: { width: 32, height: 32, borderRadius: 10, alignItems: "center", justifyContent: "center", backgroundColor: Colors.light.backgroundSecondary },
  ...
  primaryBtn: { minHeight: 54, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: Colors.light.tint, paddingHorizontal: 18 },
