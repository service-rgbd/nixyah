...
const dict: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    cookiesText: "Nous utilisons un stockage technique pour la session, les préférences et le consentement.",
    accept: "Accepter",
    continue: "Continuer",
    explore: "Explorer",
    dashboard: "Dashboard",
  ...
  en: {
    ...
    settings: "Settings",
    cookiesTitle: "Cookies",
    cookiesText: "We use technical storage for session, preferences, and consent.",
    accept: "Accept",
    continue: "Continue",
    explore: "Explore",
    dashboard: "Dashboard",
